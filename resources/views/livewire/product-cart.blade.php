        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tr>
                    <th>Discount ({{ $global_discount }}%)</th>
                    @php
                        $discount_amount = Cart::instance($cart_instance)->subtotal() * ($global_discount / 100);
                    @endphp
                ...
                <tr>
                    <th>Tax (12%)</th>
                    @php
                        $vat_base = Cart::instance($cart_instance)->subtotal() - $discount_amount;
                        $vat_amount = $vat_base * 0.12;
                    @endphp
                    <td>(+) {{ format_currency($vat_amount) }}</td>
                </tr>
                <tr>.
                    <th>Shipping</th>
                    <td>(+) {{ format_currency($shipping) }}</td>
                ...
                <tr>
                    <th>Grand Total (Excl. VAT)</th>
                    @php
                        $grand_total = $vat_base + $shipping;
                    @endphp
