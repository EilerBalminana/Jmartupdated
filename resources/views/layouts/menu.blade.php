...
<li class="c-sidebar-nav-item {{ request()->routeIs('home') ? 'c-active' : '' }}">
    <a class="c-sidebar-nav-link" href="">
        <i class="c-sidebar-nav-icon bi bi-truck" style="line-height: 1;"></i> Inventory
    </a>
</li>
...
@can('access_reports')
    <li class="c-sidebar-nav-item c-sidebar-nav-dropdown {{ request()->routeIs('*-report.index') ? 'c-show' : '' }}">
        ...
        <ul class="c-sidebar-nav-dropdown-items">
            ...
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs('low-stocks-report.index') ? 'c-active' : '' }}" href="{{ route('low-stocks-report.index') }}">
                    <i class="c-sidebar-nav-icon bi bi-clipboard-data" style="line-height: 1;"></i>Low Stocks Report
                </a>
            </li>
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link {{ request()->routeIs('inventory-report.index') ? 'c-active' : '' }}" href="{{ route('inventory-report.index') }}">
                    <i class="c-sidebar-nav-icon bi bi-clipboard-data" style="line-height: 1;"></i> Inventory Report
                </a>
            </li>
            <li class="c-sidebar-nav-item">
