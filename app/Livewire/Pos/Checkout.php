...
class Checkout extends Component
{
    ...
    public function calculateTotal() {
        ...
        $cart_subtotal = Cart::instance($this->cart_instance)->subtotal();
        $tax_amount = ($cart_subtotal * $this->global_tax) / 100;
        $discount_amount = ($cart_subtotal * $this->global_discount) / 100;
        $grand_total = $cart_subtotal - $discount_amount + $this->shipping;
    ...
    public function calculate($product) {
        ...
        if ($product['product_tax_type'] == 1) {
            ...
            $sub_total = ($product['product_price'] * ($product['product_order_tax'] / 100));
