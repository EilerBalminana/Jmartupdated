...
Route::group(['middleware' => 'auth'], function () {
    ...
    //inventory Report
    Route::get('/inventory-report', 'ReportsController@inventoryReport')
        ->name('inventory-report.index');
    //low stocks Report
    Route::get('/Low-stocks-report', 'ReportsController@lowstocksReport')
    ->name('low-stocks-report.index');
});
